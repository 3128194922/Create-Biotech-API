...
public final class GeneratedCreeperBlastChamber_685cd207 {
    ...
    private static void storyboard$0(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(20);
        GeneratedPonderSupport.showExtraStructure(scene, context, new ResourceLocation("create_biotech", "ponder/generated/ponderer/bomber.nbt"), new BlockPos(2, 1, 2), 0, false, false, false, "none", null, null, null, null, null);
    ...
    private static void storyboard$1(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(20);
        GeneratedPonderSupport.showExtraStructure(scene, context, new ResourceLocation("create_biotech", "ponder/generated/ponderer/bomber_xs.nbt"), new BlockPos(4, 1, 2), 0, false, false, false, "simultaneous", 20, 1, true, null, "down");
        scene.addKeyframe();
        ...
        GeneratedPonderSupport.showExtraStructure(scene, context, new ResourceLocation("create_biotech", "ponder/generated/ponderer/bomber_s.nbt"), new BlockPos(3, 1, 2), 0, false, false, false, "none", null, null, null, null, null);
    ...
    private static void storyboard$2(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        GeneratedPonderSupport.showStructure(scene, context, null, null, null, null);
        scene.idle(20);
        GeneratedPonderSupport.showExtraStructure(scene, context, new ResourceLocation("create_biotech", "ponder/generated/ponderer/bomber.nbt"), new BlockPos(2, 1, 2), 0, false, false, false, "simultaneous", 20, 1, true, null, "down");
        scene.idle(40);
        ...
        scene.idle(20);
        GeneratedPonderSupport.showExtraStructure(scene, context, new ResourceLocation("create_biotech", "ponder/generated/ponderer/powered_bomber.nbt"), new BlockPos(3, 4, 2), 0, false, true, false, "none", null, null, null, null, null);
        ...
        GeneratedPonderSupport.showText(scene, "【苦力怕开始被压缩】", null, 60, null, false);
        scene.idle(20);
        GeneratedPonderSupport.showText(scene, "【爆炸粒子】", null, 60, null, false);
        scene.idle(40);
        GeneratedPonderSupport.rotateCameraY(scene, -35.0f, -35.0f, 10);
        GeneratedPonderSupport.showText(scene, "【苦力怕恢复】", null, 60, null, false);
    ...
    private static void storyboard$3(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        GeneratedPonderSupport.showStructure(scene, context, null, null, null, null);
        scene.idle(20);
        GeneratedPonderSupport.showExtraStructure(scene, context, new ResourceLocation("create_biotech", "ponder/generated/ponderer/bomber.nbt"), new BlockPos(2, 1, 2), 0, false, false, false, "simultaneous", 20, 1, false, null, "down");
        scene.idle(30);
        scene.addKeyframe();
        GeneratedPonderSupport.showText(scene, "苦力怕爆破室最高接受128rpm的转速", new Vec3(4.5, 4.5, 2.0), 120, null, true);
        GeneratedPonderSupport.showExtraStructure(scene, context, new ResourceLocation("create_biotech", "ponder/generated/ponderer/128bomber.nbt"), new BlockPos(3, 4, 1), 0, false, true, false, "none", null, null, null, null, null);
        scene.idle(130);
        scene.addKeyframe();
        GeneratedPonderSupport.showText(scene, "超过128rpm的转速会使其进入过载状态", new Vec3(4.0, 4.5, 1.5), 120, "red", true);
        GeneratedPonderSupport.showExtraStructure(scene, context, new ResourceLocation("create_biotech", "ponder/generated/ponderer/256bomber.nbt"), new BlockPos(3, 4, 1), 0, false, true, false, "none", null, null, null, null, null);
        scene.idle(130);
        scene.addKeyframe();
