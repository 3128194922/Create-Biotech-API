...
public final class GeneratedCreeperBlastChamber_685cd207 {
    ...
    private static void storyboard$2(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        GeneratedPonderSupport.modifyEntitiesNbt(scene, true, "minecraft:creeper", "{ignited:1b,Fuse:30s}", null, null);
        GeneratedPonderSupport.playSound(scene, "minecraft:entity.creeper.primed", 0.5f, 1.0f, "blocks");
        scene.idle(30);
        GeneratedPonderSupport.playSound(scene, "minecraft:entity.generic.explode", 0.7f, 1.15f, "blocks");
        GeneratedPonderSupport.rotateCameraY(scene, 4.0f, 4.0f, 3);
        GeneratedPonderSupport.clearEntities(scene, true, "minecraft:creeper", null, null);
