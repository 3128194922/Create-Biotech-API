...
public class ExperienceTankItem extends BlockItem {
	...
	private void tryMultiPlace(BlockPlaceContext ctx) {
		...
		if (!ExperienceTankBlock.isTank(placedOnState))
			return;
		if (SymmetryWandItem.presentInHotbar(player))
			return;
		ExperienceTankBlockEntity tankAt =
			ConnectivityHandler.partAt(CBBlockEntityTypes.EXPERIENCE_TANK.get(), world, placedOnPos);
		if (tankAt == null)
			return;
